...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Return HTML with embedded intelligence
    const html = getHTMLTemplate(intelligenceData, personData);
...
function getHTMLTemplate(intelligence, person) {
  const intelligenceScript = intelligence ? `
    <script>
      window.WILLOW_INTELLIGENCE = ${JSON.stringify(intelligence)};
      window.WILLOW_PERSON = ${JSON.stringify(person)};
    </script>
  ` : '';
...
<body>
  ...
  <div id="willow-container">
    <!-- Navigation Tabs -->
    <nav id="willow-tabs">
      <button class="tab-button active" data-tab="intelligence">🎯 Intelligence</button>
      <button class="tab-button" data-tab="cma">📈 CMA</button>
      ...
      <button class="tab-button" data-tab="management">⚙️ System</button>
    </nav>
  ...
  <script>
    ...
    class WILLOWEmbeddedApp {
      ...
      renderCMAHub() {
        return `
          <div class="cma-hub">
            <h3 style="margin-bottom: 20px;">📈 CMA Generation & Management</h3>
            ...
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border); margin-bottom: 20px;">
              ...
              <div style="margin-top: 15px; padding: 10px; background: var(--fub-background); border-radius: 4px;">
                <small style="color: var(--fub-text-muted);">
                  ...
                  ${this.intelligence?.classification} priority • 
                  ${this.getOptimizedRadius()} mile radius • 
            ...
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border);">
              <h4 style="margin-bottom: 15px;">🏠 Recent CMA Activity</h4>
      ...
      renderAnalytics() {
        return `
          <div class="analytics-dashboard">
            <h3 style="margin-bottom: 20px;">📊 Lead Analytics & Performance</h3>
            ...
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border);">
              <h4 style="margin-bottom: 15px;">📈 Revenue Opportunity</h4>
      ...
      renderPartners() {
        return `
          <div class="partners-dashboard">
            <h3 style="margin-bottom: 20px;">🤝 Partner Coordination System</h3>
            
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border); margin-bottom: 20px;">
              <h4 style="margin-bottom: 15px;">🎯 Optimal Partner Assignment</h4>
      ...
      renderProperty() {
        return `
          <div class="property-dashboard">
            <h3 style="margin-bottom: 20px;">🏠 Property Intelligence Hub</h3>
            
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border); margin-bottom: 20px;">
              <h4 style="margin-bottom: 15px;">📊 Market Intelligence</h4>
      ...
      renderHomebeatStatus() {
        return `
          <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border);">
            <h4 style="margin-bottom: 15px;">📈 Homebeat Monitoring</h4>
      ...
      renderCommunication() {
        return `
          <div class="communication-dashboard">
            <h3 style="margin-bottom: 20px;">📧 Communication & Follow-Up Center</h3>
            
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border); margin-bottom: 20px;">
              <h4 style="margin-bottom: 15px;">📬 Email Intelligence</h4>
              <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 10px;">
                <div style="text-align: center; padding: 10px;">
            ...
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border);">
              <h4 style="margin-bottom: 15px;">⚡ Recommended Follow-Up</h4>
              <div style="padding: 15px; background: var(--fub-background); border-radius: 6px;">
      ...
      renderManagement() {
        return `
          <div class="management-dashboard">
            <h3 style="margin-bottom: 20px;">⚙️ System Management & Sync</h3>
            
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border); margin-bottom: 20px;">
              <h4 style="margin-bottom: 15px;">🔄 Integration Status</h4>
            ...
            <div style="background: var(--fub-card); padding: 20px; border-radius: 8px; border: 1px solid var(--fub-border);">
              <h4 style="margin-bottom: 15px;">📊 Custom Fields (${this.getCustomFieldCount()} total)</h4>
              <div style="font-size: 13px; color: var(--fub-text-muted); line-height: 1.6;">
                • <strong>22 WILLOW fields</strong> (write-enabled): Behavioral intelligence, CMA data, market analysis<br>
                • <strong>16 Fello fields</strong> (read-only): Lead scoring, engagement metrics, property intelligence<br>
                • <strong>15 CloudCMA fields</strong> (write-enabled): MLS intelligence, market conditions, CMA analytics<br>
                • <strong>2 Other fields</strong>: Additional property and system data
              </div>
            </div>
          </div>
        `;
